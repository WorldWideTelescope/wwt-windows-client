...
public class CAACalendarDate
{
    ...
    public CAACalendarDate(int year, int month, int day)
    {
        Year = year;
        Month = month;
        Day = day;
...
//Constructors / Destructors
  ...
  public CAADate(int Year, int Month, double Day, bool bGregorianCalendar)
  {
	Set(Year, Month, Day, 0, 0, 0, bGregorianCalendar);
  }
  public CAADate(int Year, int Month, double Day, double Hour, double Minute, double Second, bool bGregorianCalendar)
  {
...
//  static int @int(double value);
  ...
  public static double DayOfYear(double JD, int Year, bool bGregorianCalendar)
  {
	return JD - DateToJD(Year, 1, 1, bGregorianCalendar) + 1;
  }
  public static int DaysInMonth(int Month, bool bLeap)
  {
