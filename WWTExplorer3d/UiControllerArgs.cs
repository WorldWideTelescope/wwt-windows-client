...
namespace TerraViewer
{
    ...
    public class UiControllerMouseArgs
    {
        //
        // Summary:
        ...
        public UiControllerMouseArgs(UiMouseButtons button, int clicks, int x, int y, int delta, Vector2d location)
        {
            Button = button;
            Clicks = clicks;
            X = x;
...
#if !WINDOWS_UWP
        public UiControllerMouseArgs(System.Windows.Forms.MouseEventArgs e)
        {
            Button = (UiMouseButtons)(int)e.Button;
            Clicks = e.Clicks;
            X = e.X;
            Y = e.Y;
            Delta = e.Delta;
            Location = new Vector2d(e.Location.X, e.Location.Y);
        }
#endif
        //
        // Summary:
    ...
    public class UiControllerKeyArgs
    {
        //
        // Summary:
        ...
        public UiControllerKeyArgs(UiKeys keyData)
        {
            keyCode = keyData;
        }
        private UiKeys keyCode;
        //
        // Summary:
        ...
        public virtual bool Alt
        {
            get
            {
                return keyCode.HasFlag(UiKeys.Alt);
            }
        }
        //
        // Summary:
        ...
        public bool Control
        {
            get
            {
                return keyCode.HasFlag(UiKeys.Control);
            }
        }
        //
        // Summary:
        ...
        public virtual bool Shift
        {
            get
            {
                return keyCode.HasFlag(UiKeys.Shift);
            }
        }
    }
