...
namespace TerraViewer
{
    public struct Coordinates
    {
        ...
        //static void AltAzToRaDec(double Altitude, double Azimuth, out double hrAngle, out double dec, double Latitude)
        //{
        //    hrAngle = Math.Atan2(-Math.Cos(Azimuth), Math.Sin(Azimuth) * Math.Sin(Latitude) + Math.Tan(Altitude) * Math.Cos(Latitude));

        //    if (hrAngle < 0)
        //    {
        //        hrAngle += Math.PI;
        //    }
        //    dec = Math.Asin(Math.Sin(Latitude) * Math.Sin(Altitude) - Math.Cos(Latitude) * Math.Cos(Altitude) * -Math.Sin(Azimuth));
        //}
        //static void AltAzToRaDec5(double Altitude, double Azimuth, out double hrAngle, out double dec, double Latitude)
        //{
        //    dec = Math.Asin(Math.Sin(Altitude) * Math.Sin(Latitude) + Math.Cos(Altitude) * Math.Cos(Latitude) * Math.Cos(Azimuth));
        //    hrAngle = Math.Asin(-Math.Sin(Azimuth)*Math.Cos(Altitude)/Math.Cos(dec));
        //    hrAngle2 = Math.Acos((Math.Sin(Altitude) - Math.Sin(dec) * Math.Sin(Latitude)) / Math.Cos(dec) * Math.Cos(Latitude));
        //}  

        //static void AltAzToRaDec3(double Altitude, double Azimuth, out double hrAngle, out double dec, double Latitude)
        //{
        //    Azimuth = Math.PI - Azimuth;
        //    if (Azimuth < 0)
        //    {
        ...
        //static public Coordinates CartesianToSpherical3(Vector3 vector)
        //{
        //    double ascention;
        //    double declination;
