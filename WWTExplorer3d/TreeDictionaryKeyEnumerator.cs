//------------------------------------------------------------------------------
// Abstract implementation of a Red-Black tree Key enumerator
//
// <copyright file="TreeDictionaryKeyEnumerator.cs" company="Microsoft">
...
{
    public sealed class TreeDictionaryKeyEnumerator<TKey, TValue> : IEnumerator<TKey>, IEquatable<TreeDictionaryKeyValuePairEnumerator<TKey, TValue>>, IComparable<TreeDictionaryKeyValuePairEnumerator<TKey, TValue>>, IEquatable<TreeDictionaryKeyEnumerator<TKey, TValue>>, IComparable<TreeDictionaryKeyEnumerator<TKey, TValue>>, IEquatable<TreeDictionaryValueEnumerator<TKey, TValue>>, IComparable<TreeDictionaryValueEnumerator<TKey, TValue>>
    {
        ...
        public TreeDictionaryKeyEnumerator(TreeDictionaryKeyValuePairEnumerator<TKey, TValue> enumerator)
        {
        ...
        public TreeDictionaryKeyEnumerator(TreeDictionaryKeyEnumerator<TKey, TValue> enumerator)
        {
            this.comparer = enumerator.comparer;
            this.loopbackNode = enumerator.loopbackNode;
            this.node = enumerator.node;
        ...
        public TreeDictionaryKeyEnumerator(TreeDictionaryValueEnumerator<TKey, TValue> enumerator)
        {
            this.comparer = enumerator.comparer;
            this.loopbackNode = enumerator.loopbackNode;
            this.node = enumerator.node;
        ...
        internal TreeDictionaryKeyEnumerator(TreeDictionary<TKey, TValue> tree, TreeDictionary<TKey, TValue>.TreeNode node, bool isGoingDown, uint statusBits)
        {
